...
[![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://codedreamer812-openai-api-web-apps-home-xbxlm8.streamlit.app/)
...
Welcome to the **[unofficial platform for custom web applications powered by OpenAI APIs](https://codedreamer812-openai-api-web-apps-home-xbxlm8.streamlit.app/)**! This repository hosts
...
### Talk to GPT
[![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://codedreamer812-openai-api-web-apps-home-xbxlm8.streamlit.app/Talk_To_GPT)

The first web application, **[Talk to GPT](https://codedreamer812-openai-api-web-apps-home-xbxlm8.streamlit.app/Talk_To_GPT)**, is an interactive chatbot application that allows users to
...
### CodeMaxGPT
[![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://codedreamer812-openai-api-web-apps-home-xbxlm8.streamlit.app/CodeMaxGPT)

The second web application, **[CodeMaxGPT](https://codedreamer812.github.io/intro-codemaxgpt.html)**, is designed to provide coding assistance to programmers. Built on OpenAI's [**Assistants API**](https://platform.openai.com/docs/assistants/overview?context=with-streaming),
...
**[Talk to GPT](https://codedreamer812-openai-api-web-apps-home-xbxlm8.streamlit.app/Talk_To_GPT)** provides the following features:
...
Below are the features offered by **[CodeMaxGPT](https://codedreamer812.github.io/intro-codemaxgpt.html)**:
...
<p align='center'>
    <img width=600 src="https://github.com/codedreamer812/OpenAI-API-Web-Apps/assets/55864839/e0f8020a-0128-45ca-83f0-af658ab1e37a">
...
<p align='center'>
    <img width=600 src="https://github.com/codedreamer812/OpenAI-API-Web-Apps/assets/55864839/9184302a-0e0f-4488-a207-b7dafdc4675a">
...
1. Visit the [**Introducing CodeMaxGPT**](https://codedreamer812.github.io/intro-codemaxgpt.html) webpage.
2. Click on the "Get started now" button, and you'll be directed to the [**CodeMaxGPT on Streamlit**](https://codedreamer812-openai-api-web-apps-home-xbxlm8.streamlit.app/CodeMaxGPT).
...
For a detailed demonstration of using **CodeMaxGPT**, please visit the [**introduction page**](https://codedreamer812.github.io/intro-codemaxgpt.html) of the web application, or click on the badge below.

[![Watch Demos - CodeMaxGPT](https://img.shields.io/badge/Watch_Demos-CodeMaxGPT-6699FF)](https://codedreamer812.github.io/intro-codemaxgpt.html)
...
Thank you for choosing to use the [**OpenAI API Web Apps**](https://codedreamer812-openai-api-web-apps-home-xbxlm8.streamlit.app/). I hope that these applications will greatly amplify your programming capabilities and boost your efficiency, both in your work and in your everyday life.
